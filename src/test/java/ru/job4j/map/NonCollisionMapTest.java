...
class NonCollisionMapTest {
    ...
    @Test
    void whenCheckPut1and2isTrue() {
        SimpleMap<Integer, String> map = new NonCollisionMap<>();
        assertThat(map.put(1, "0")).isTrue();
        assertThat(map.put(2, "0")).isTrue();
        assertThat(map).hasSize(2);
    }

    @Test
    void whenCheckPut1and2isFalse() {
    ...
    @Test
    void whenRemove10and11isFalse() {
        assertThat(map.remove(10)).isFalse();
        assertThat(map.remove(11)).isFalse();
        assertThat(map).hasSize(4);
    }
}